...
class ULensDistortionBlueprintLibrary : public UBlueprintFunctionLibrary
{
	...
	UFUNCTION(BlueprintPure, Category = "CustomShader | Lens Distortion")
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "CustomShader | Lens Distortion", meta = (WorldContext = "WorldContextObject"))
	...
	UFUNCTION(BlueprintPure, meta=(DisplayName = "Equal (LensDistortionCameraModel)", CompactNodeTitle = "==", Keywords = "== equal"), Category = "CustomShader | Lens Distortion")
	static bool EqualEqual_CompareLensDistortionModels(
		const FCustomShaderCameraModel& A,
		const FCustomShaderCameraModel& B)
	{
		return A == B;
	}

	/* Returns true if A is not equal to B (A != B) */
	UFUNCTION(BlueprintPure, meta = (DisplayName = "NotEqual (LensDistortionCameraModel)", CompactNodeTitle = "!=", Keywords = "!= not equal"), Category = "CustomShader | Lens Distortion")
